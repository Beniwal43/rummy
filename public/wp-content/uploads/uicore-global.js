!(function (r) {
  ...
  window.uicoreJsonp = function (o, u, c) {
    for (var i, f, l, p = 0, a = []; p < o.length; p++)
      (f = o[p]), e[f] && a.push(e[f][0]), (e[f] = 0);
    for (i in u) Object.prototype.hasOwnProperty.call(u, i) && (r[i] = u[i]);
    for (n && n(o, u, c); a.length; ) a.shift()();
    if (c) for (p = 0; p < c.length; p++) l = t((t.s = c[p]));
    return l;
  };
  var o = {},
    e = { 19: 0 };
  ...
  [5],
  {
    ...
    181: function (e, i, n) {
      ...
      jQuery(document).ready(function () {
        if (
          jQuery(".uicore-sticky").length ||
          jQuery(".uicore-will-be-sticky").length
        ) {
          var e = function () {
            var e = window.matchMedia("(max-width: 1025px)").matches,
              ...
              r = 100;
            jQuery(".uicore-transparent .ui-header-row1").length
              ? (r = 10)
              : jQuery(".ui-header-row1").length && (r = 400),
              null == o && (o = e ? 25 : r),
              n > o
              ...
              n + jQuery(window).height() > jQuery(document).height() - 50 &&
                jQuery(".ui-smart-sticky").removeClass("ui-hide"),
              (i = n);
          };
          e();
          ...
          jQuery(window).on("scroll", e),
            jQuery(document.body).on("touchmove", n);
        }
      }),
        ...
        jQuery(function (e) {
          e(".uicore-search-btn").click(function () {
            e("body").addClass("uicore-search-active"),
              e(".uicore-search .search-field").focus();
          }),
            ...
            e(
              ".uicore-h-classic .menu-item-has-children:not(.menu-item-has-megamenu.custom-width)"
            ).on("mouseenter mouseleave", function (i) {
              if (e("ul", this).length) {
                var n = e(".sub-menu", this);
                n.offset().left + n.width() > e("body").width() &&
                  e(this).addClass("uicore-edge");
              }
            });
          var i = e("#uicore-back-to-top");
          jQuery(window).scroll(function () {
            jQuery(window).scrollTop() > 300
              ? i.addClass("uicore-visible")
              : i.removeClass("uicore-visible");
          }),
            ...
            if (jQuery(".uicore-progress-bar").length) {
              var i,
                ...
                o = function () {
                  ...
                  return (
                    i.length &&
                      (e = i.height() + i.offset().top - window.innerHeight),
                    e
                  );
                },
      ...
      jQuery(function (e) {
        e(document).ready(function () {
          var i = window.matchMedia(
            "(max-width: " + window.uicore_frontend?.mobile_br + "px)"
          ).matches;
          function n() {
            e(".uicore-mobile-menu-wrapper .menu-item-has-children > a").unbind(
              "click",
              r
            ),
              e(
                ".uicore-mobile-menu-wrapper .uicore-menu-container .sub-menu .back > a"
              ).unbind("click", u),
              e(
                ".uicore-mobile-menu-wrapper .menu-item-has-children > a:not(.ui-custom-tap)"
              ).unbind("click", o),
              e(
                ".uicore-mobile-menu-wrapper li:not(.menu-item-has-children):not(.back) > a"
              ).unbind("click", m),
              e(
                ".uicore-mobile-menu-wrapper.uicore-ham-classic .menu-item-has-children"
              ).unbind("mouseenter", c),
              e(
                ".uicore-mobile-menu-wrapper.uicore-ham-classic .menu-item-has-children"
              ).unbind("mouseleave", t),
              e(
                ".uicore-mobile-menu-wrapper.uicore-ham-center .menu-item-has-children a, .uicore-mobile-menu-wrapper.uicore-ham-creative .menu-item-has-children a"
              ).unbind("click", a),
              e(".uicore-menu-focus .uicore-menu li").unbind("mouseenter", s),
              e(".uicore-menu-focus .uicore-menu li").unbind("mouseleave", l),
              i
                ? (document.body.classList.contains("ui-a-dsmm-slide")
                    ? (!(function () {
                        if (!window.uicoreBackLinks) {
                          for (
                            var i = jQuery(".menu-item-has-children"), n = 0;
                            n < i.length;
                            n++
                          ) {
                            var o = i[n],
                              r = e("<a>", {
                                href: "#",
                                text: uicore_frontend.back
                                  ? uicore_frontend.back
                                  : "Back",
                              }),
                              u = e("<li>", { class: "menu-item back" });
                  ...
                  window.uicoreParent ||
                    ((window.uicoreParent = !0),
                    e(
                      ".uicore-mobile-menu-wrapper .uicore-menu-container .menu-item-has-children"
                    ).each(function (i, n) {
                ...
                : (e(
                  ...
                  e(".uicore-menu-focus .uicore-menu li").bind("mouseenter", s),
                  e(".uicore-menu-focus .uicore-menu li").bind(
                    "mouseleave",
                    l
                  ));
          }
          function o(i) {
            i.preventDefault(),
              e(this).siblings(".sub-menu").slideToggle(),
              e(this).toggleClass("ui-expanded"),
              e(this).siblings().toggleClass("uicore-active"),
              d();
          }
          function r(i) {
            i.preventDefault();
            var n = "";
            e(".uicore-mobile-menu-wrapper .uicore-menu ").addClass(
              "uicore-animating"
            ),
              e(this).siblings().addClass("uicore-active");
            var o = e(
              ".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu"
            )[0].style.left;
            "0" == o || "0%" == o || "" == o
              ? (n = "-100%")
              : ((o = o.replace("-", "").replace("%", "")),
                (n = "-" + (parseInt(o) + 100) + "%")),
              "1" === uicore_frontend.rtl && (n = n.replace("-", "+")),
              e(
                ".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu"
              )
                .delay(200)
                .animate({ left: n }, 300, function () {
                  d(),
                    e(
                      ".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu "
                    ).removeClass("uicore-animating");
                });
          }
          function u(i) {
            i.preventDefault();
            ...
            e(
              ".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu"
            ).addClass("uicore-animating");
            var o = e(
              ".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu"
            )[0].style.left;
            "-100%" == o || "0%" == o || "" == o || "+100%" == o || "100%" == o
              ? (n = "0%")
              : ((o = o.replace("-", "").replace("%", "")),
                (n = "-" + (parseInt(o) - 100) + "%")),
              "1" === uicore_frontend.rtl && (n = n.replace("-", "+"));
            ...
            setTimeout(function () {
              ...
              e(
                ...
                .animate({ left: n }, 300, function () {
                  e(
                    ".uicore-mobile-menu-wrapper .uicore-menu .sub-menu:not(.uicore-active) li"
                  ).removeClass("uicore-visible"),
                    d(),
                    e(
                      ".uicore-mobile-menu-wrapper .uicore-menu-container .uicore-menu "
                    ).removeClass("uicore-animating");
          ...
          function c(i) {
            e(this).find(".sub-menu:first").addClass("uicore-active"), d();
          }
          function t(i) {
            e(this).children(".sub-menu:last").removeClass("uicore-active"),
              e(this).find("li").removeClass("uicore-visible");
          }
          function a(i) {
            e(this)
              .parent()
              .find(".sub-menu:first")
              .toggleClass("uicore-active"),
              e(this).parent().find(".sub-menu:first").slideToggle(),
              e(this).parent().find(".sub-menu:first").hasClass("uicore-active")
                ? d()
                : e(this).parent().find("li").removeClass("uicore-visible");
          }
          function s() {
            e(this).siblings("li").stop().fadeTo(300, 0.4),
              e(this).parent().siblings("li").stop().fadeTo(300, 0.3);
          }
          function l() {
            e(this).siblings("li").stop().fadeTo(300, 1),
              e(this).parent().siblings("li").stop().fadeTo(300, 1);
          }
          function m(n) {
            ...
            if (o) {
              ...
              if (
                r[0] &&
                r[0] != window.location.pathname &&
                r[0] != window.location.href.split("#")[0]
              )
                return;
            }
            if (!window.uicoreAnimation) {
              ...
              if (document.body.classList.contains("uicore-overflow-hidden"))
                e(".uicore-mobile-menu-overflow").removeClass(
                  "uicore-overflow-hidden"
                ),
                  e("body").removeClass("uicore-overflow-hidden"),
                  e("body").removeClass("uicore-mobile-nav-show"),
                  i
                    ? e(".uicore-animate-fade").length > 0
                  ...
                  e(".uicore-mobile-menu-wrapper li").removeClass(
                    "uicore-visible"
                  ),
                  e(".uicore-ham-reveal").css("animation-name", "none");
              else {
                var c = 0;
                u.length
                  ? (i ||
                      (e(".uicore-ham-reveal").css(
                        "animation-name",
                        "uiCoreAnimationsHamReveal"
                      ),
                      (c = 100)),
                    setTimeout(function () {
                  ...
                  e("body").addClass("uicore-overflow-hidden"),
                  setTimeout(function () {
                    e("body").addClass("uicore-mobile-nav-show"),
                      e(".uicore-mobile-menu-overflow").addClass(
                        "uicore-overflow-hidden"
                      ),
                      e(
          ...
          n(),
            (window.onresize = n),
            e(".uicore-toggle").click(function () {
              m();
            });
        });
      });
    ...
    183: function (e, i, n) {
      ...
      jQuery(document).ready(function () {
        ...
        [].forEach.call(e, function (e, i) {
          ...
          jQuery(".menu-item-object-uicore-tb").on(
...
if (mq.matches) {
  ...
  var menuItems = document.querySelectorAll(
    ".uicore-header-wrapper ul.uicore-menu > .menu-item > a"
  );
  var extraItems = document.querySelectorAll(
    "#wrapper-navbar .uicore-extra > *"
  );
  menuItems = logo
    ? [logo, ...menuItems, ...extraItems]
    : [...menuItems, ...extraItems];
  var ham = document.querySelectorAll(
    "#wrapper-navbar nav .uicore-ham:not(.uicore-drawer-toggle)"
  )[0];
  if (ham) {
...
document.querySelectorAll(".ui-cursor").forEach((cursor) => {
  ...
  if (
    !document.getElementsByClassName("e-preview--show-hidden-elements").length
  ) {
...
window.addEventListener(
  ...
  () => {
    jQuery(
      ' input[type="button"], input[type="submit"], .elementor-button.elementor-button, .elementor-button:not(.bdt-offcanvas-button), .bdt-button-primary, .bdt-ep-button,button.metform-btn,button.metform-btn:not(.toggle), .bdt-callout a.bdt-callout-button, [type="submit"], .tutor-button, .tutor-login-form-wrap input[type="submit"], .wp-block-button__link,.uicore-mobile-menu-wrapper .uicore-cta-wrapper a,.uicore-navbar a.uicore-btn, .bdt-contact-form .elementor-button,.ui-attract'
